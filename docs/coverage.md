...
<!-- GENERATED FILE — DO NOT EDIT BY HAND.
     Generated:  2026-09-26T16:02:36Z
...
Computed from **57** recorded run(s) and the procedure files in this checkout, at **2026-09-26T16:02:36Z**.
...
|---|---|:-:|:-:|:-:|:-:|---|---|
| `gps_degradation` | fault | yes | yes | yes | yes | `20260926T155248Z_sitl_quad_degradation`, `20260926T155312Z_sitl_quad_degradation` | **VERIFIED** |
| `gps_loss` | fault | yes | yes | yes | yes | `20260926T155540Z_sitl_quad_scenario`, `20260926T155604Z_sitl_quad_scenario` | **VERIFIED** |
| `mavlink_degradation` | fault | yes | yes | yes | yes | `20260926T155336Z_sitl_quad_degradation` | **VERIFIED** |
| `mavlink_interrupt` | fault | yes | yes | yes | yes | `20260926T155649Z_sitl_quad_scenario` | **VERIFIED** |
| `copter_gps_degradation` | procedure | yes | yes | yes | yes | `20260926T155248Z_sitl_quad_degradation`, `20260926T155312Z_sitl_quad_degradation` | **VERIFIED** |
| `copter_gps_loss` | procedure | yes | yes | yes | yes | `20260926T155540Z_sitl_quad_scenario`, `20260926T155604Z_sitl_quad_scenario` | **VERIFIED** |
| `copter_land` | procedure | yes | yes | yes | yes | `20260812T073659Z_bicopter`, `20260812T073904Z_hexapod_copter` | **VERIFIED** |
| `copter_link_degradation` | procedure | yes | yes | yes | yes | `20260926T155336Z_sitl_quad_degradation` | **VERIFIED** |
| `copter_link_loss` | procedure | yes | yes | yes | yes | `20260926T155649Z_sitl_quad_scenario` | **VERIFIED** |
...
| `plane_land_rtl` | procedure | yes | yes | yes | yes | `20260926T160123Z_sitl_plane` | **VERIFIED** |
| `plane_takeoff` | procedure | yes | yes | yes | yes | `20260812T074209Z_skywalker_x8`, `20260812T075216Z_wsc_aircraft` | **VERIFIED** |
| `tailsitter_takeoff` | procedure | yes | yes | yes | yes | `20260926T083034Z_skycat_tvbs`, `20260926T155954Z_sitl_tailsitter` | **VERIFIED** |
